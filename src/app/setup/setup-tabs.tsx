        ...
        content: (
          <div>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-[var(--space-sm)] rounded-[var(--radius-sm)] border border-[var(--color-accent)]/50 bg-[var(--color-accent)]/10 px-[var(--space-xl)] py-[var(--space-md)] min-h-[48px] font-[family-name:var(--font-mono)] text-[0.875rem] font-medium uppercase tracking-wider text-[var(--color-accent)] transition-all duration-200 hover:bg-[var(--color-accent)]/20 hover:border-[var(--color-accent)] hover:shadow-[var(--glow-cyan)] hover:scale-[1.02] w-full"
            >
              ⬇ {p.linkLabel}
            </a>
